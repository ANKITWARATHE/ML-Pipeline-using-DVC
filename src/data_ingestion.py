...
def load_data(data_url: str) -> pd.DataFrame:
    ...
    try:
        ...
        print(f"Error: An unexcepted error occurred while loading the data.")
        print(e)
        raise
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        print(f"Error: An unexcepted error occurred while preprocessing the data.")
        print(e)
        raise
...
def save_data(train_data: pd.DataFrame, test_data: pd.DataFrame, data_path: str) -> None:
    try:
        ...
        print(f"Error: An unexcepted error occurred while saving the data.")
        print(e)
        raise
